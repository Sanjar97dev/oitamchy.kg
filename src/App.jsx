...
const App = () => {
  ...
  return (
    <div className="container"> {/* Added Bootstrap container class */}
      ...
      <hr/>
      <h1>Санжар
Ассаламу алейкум окурман. Бул проектти мен жаңы жасап жатам Аллахым кааласа буюрса дагы да бул ишти өркундөтуп жасап чыгайын деген максаттым бар. Ушул кесибим менен Ислам динибизге, өлкөбүз Кыргызстанга, үй-бүлөөбүзгө кызмат кылабыз деген бекем ниеттим бар.</h1>
